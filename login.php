        ...
        <div class="centerPanel">
            <div class="l-flexChild">
                <div class="pageHead">
                    ...
                    <h1 class="pageHead__title u-taCenter u-mbS">ログイン</h1>
                    <p class="pageHead__body u-taCenter">ログインのために右の情報を入力してください！</p>
                </div>
            </div>
            <div class="l-flexChild">
                <form action="#" method="post" class="form">
                    ...
                    <div class="">
                        <button class="form__button containedButton">これでログイン！</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="l-container--sp u-dispNone--pc l-escapeHeader--sp">
        <div class="textbox">
            <div class="l-flex u-mbS">
                ...
                <h1 class="textbox__head">ログイン</h1>
            </div>
            <p class="textbox__body">ログインのために以下の情報を入力してください</p>
        </div>
        <form action="#" method="post" class="form">
            ...
            <div class="l-flexCenter">
                <button class="form__button containedButton containedButton--reverse" type="submit" value="submit">これでログイン！</button>
            </div>
        </form>
    </div>
</div>
